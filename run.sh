...
clumpit () {
    ...
    local exposure=${1}
    sbatch --job-name=ld_${exposure} --output=/scratch/andreeki/gwis/clump_combined/logs/FIGI_v2.4_${exposure}_ldclump.log --export=exposure=${exposure},hrc_version='v2.4'  clump.sh
}
