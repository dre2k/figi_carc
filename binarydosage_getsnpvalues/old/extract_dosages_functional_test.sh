...
wrapper () {
                local exposure=${1}
                Rscript extract_dosages_functional_test.R \
                /scratch/andreeki/gwis/twostep_expectation_hybrid/figi_controls_1000.rds \
                /scratch/andreeki/gwis/twostep_expectation_hybrid/${exposure}/${exposure}_snplist_functional_annotation_test_chiSqGxE_chr${SLURM_ARRAY_TASK_ID}.rds
}
